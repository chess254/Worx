...
class generateTimeSlots{
    ...
    function __construct($period_start, $period_end, $interval, $occupied_slots) {
      $this->pitchStart = new DateTime($period_start);
      $this->pitchClose = new DateTime($period_end);
      $this->games = $occupied_slots;
    ...
    function slots_used_by_game($slots, $games, $slot_interval) {
        ...
        foreach($games as $game){
            $game_duration = Carbon::parse($game['end'])->diff(Carbon::parse($game['start']));
